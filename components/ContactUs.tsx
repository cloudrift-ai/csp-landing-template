...
const ContactUs = () => {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    const mailtoLink = `mailto:support@[[Brand]].ai?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\n\nMessage:\n${formData.message}`)}`;
