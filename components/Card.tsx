...
const Card: React.FC<CardProps> = (props) => {
  ...
  if (props.variant === 'pricing') {
    ...
    return (
      <div className={`${baseStyles} ${pricingBorderClass} w-full md:max-w-[360px] p-8`}>
        ...
        <Link href={buttonLink} className="block w-full py-2 px-4 text-center bg-accent text-primary rounded-lg hover:bg-primary-dark hover:text-foreground transitions transition-colors duration-200" >
            {buttonLabel}
        </Link>
      </div>
    );
